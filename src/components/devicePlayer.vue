...
<div id="devicePlayer" v-loading="isLoging">
    ...
    <el-dialog title="视频播放" top="0" :close-on-click-modal="false"    v-model="showVideoDialog"  @close="close()">
        <!-- <LivePlayer v-if="showVideoDialog" ref="videoPlayer" :videoUrl="videoUrl" :error="videoError" :message="videoError" :hasaudio="hasaudio" fluent autoplay live></LivePlayer> -->
        <player ref="videoPlayer" v-model:visible="showVideoDialog" :videoUrl="videoUrl" :error="videoError" :message="videoError" :height="false" :hasAudio="hasAudio" fluent autoplay live ></player>
<!--        <div id="shared" style="text-align: right; margin-top: 1rem;">
            <el-tabs v-model="tabActiveName" @tab-click="tabHandleClick">
                <el-tab-pane label="实时视频" name="media">
                    <div style="margin-bottom: 0.5rem;">
                        &lt;!&ndash; <el-button type="primary" size="small" @click="playRecord(true, '')">播放</el-button>&ndash;&gt;
                        &lt;!&ndash; <el-button type="primary" size="small" @click="startRecord()">录制</el-button>&ndash;&gt;
                        &lt;!&ndash; <el-button type="primary" size="small" @click="stopRecord()">停止录制</el-button>&ndash;&gt;
                    </div>
                ...
                &lt;!&ndash;{"code":0,"data":{"paths":["22-29-30.mp4"],"rootPath":"/home/kkkkk/Documents/ZLMediaKit/release/linux/Debug/www/record/hls/kkkkk/2020-05-11/"}}&ndash;&gt;
...
export default {
  ...
  methods: {
    ...
    getUrlByStreamInfo (streamInfo) {
      const baseZlmApi = process.env.NODE_ENV === 'development' ? `${location.host}/debug/zlm` : `${location.host}/zlm`
    ...
    setSpeedOrTime: function (cmdCode, groupNum, parameter) {
      const that = this
      const parameter2 = parameter % 256
      const combindCode2 = Math.floor(parameter / 256) * 16
    ...
    gbSeek (val) {
      ...
      const showTime = new Date(new Date(this.recordStartTime).getTime() + this.seekTime * val / 100)
      const hour = showTime.getHours()
      const minutes = showTime.getMinutes()
      const seconds = showTime.getSeconds()
